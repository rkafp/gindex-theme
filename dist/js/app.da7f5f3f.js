(function(e) {
    ...
    }, s.p = "https://cdn.jsdelivr.net/gh/rkafp/gindex-theme@v2.0.12/dist/", s.oe = function(e) {
    ...
    "0853": function(e, t, a) {
        ...
        var n = function() {
            ...
            c = {
                ...
                computed: Object(o["a"])({}, Object(i["mapState"])("idnx/aplayer", ["player", "audios", "openedAudios"]), {
                    container: function() {
                ...
                methods: Object(o["a"])({}, Object(i["mapActions"])("idnx/aplayer", ["load", "set"]))
            },
            s = c,
            u = a("2877"),
    ...
    "56d7": function(e, t, a) {
        ...
        var n = a("896a"),
            ...
            l = {
                ...
                data: function() {
                    return {
                        github: "https://github.com/rkafp/gindex-theme"
                    }
                },
                watch: {
        ...
        document.write('<script>var _hmt=_hmt||[];(function(){var hm=document.createElement("script");hm.src="https://hm.baidu.com/hm.js?6be1011f95a1bfcdb2179fe2ae6e58fe";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(hm,s)})();<\/script>'), i.a.config.productionTip = !1, i.a.prototype.$cdnpath = S["a"], i.a.use(r.a), i.a.use(g.a, m["a"]), i.a.use(E), i.a.use(N["a"], {
            ...
            mounted: function() {
                this.$store.dispatch("idnx/view/load")
            }
        }).$mount("#app")
    },
    5726: function(e, t) {
    ...
    "6c69": function(e, t, a) {
        ...
        var n = function() {
            ...
            b = {
                ...
                methods: Object(h["a"])({}, Object(v["mapActions"])("idnx/db", ["databaseClear"]), {
                    cleanCache: function() {
                        var e = this;
    ...
    "95a2": function(e, t, a) {
        ...
        var n = a("5726"),
            ...
            c = a("c276"),
            s = a("60bb"),
            u = new i.a("gindex-".concat("2.0.12")),
            d = r()(u);
    ...
    "9bd2": function(e, t, a) {
        ...
        var n = a("cebe"),
            ...
            c = r.a.create({
                baseURL: Object({
                    ...
                    VUE_APP_CDN_PATH: "https://cdn.jsdelivr.net/gh/rkafp/gindex-theme@v2.0.12/dist/",
                    VUE_APP_VERSION: "2.0.12",
                    VUE_APP_G2INDEX_VERSION: "1.1.2",
                    BASE_URL: "https://cdn.jsdelivr.net/gh/rkafp/gindex-theme@v2.0.12/dist/"
                }).VUE_APP_API ? Object({
                    NODE_ENV: "production",
                    VUE_APP_I18N_LOCALE: "zh-chs",
                    VUE_APP_I18N_FALLBACK_LOCALE: "en",
        ...
        c.interceptors.request.use((function(e) {
            return e.cancelToken = new r.a.CancelToken((function(e) {
                o["a"].dispatch("idnx/cancelToken/push", e)
            })), e
        }), (function(e) {
            ...
            var e = Object(n["a"])(regeneratorRuntime.mark((function e(t, a, n) {
                return regeneratorRuntime.wrap((function(e) {
                    while (1) switch (e.prev = e.next) {
                        case 0:
                            d.a.start(), m["a"].dispatch("idnx/cancelToken/cancel"), n();
                        case 4:
                        case "end":
                            return e.stop()
                    }
        ...
        var n = a("be65"),
            ...
            o = {
                set: function() {
                    ...
                    Object.assign(n, a), r.a.set("gindex-".concat("2.0.12", "-").concat(e), t, n)
                },
                get: function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "default";
                    return r.a.get("gindex-".concat("2.0.12", "-").concat(e))
                },
                getAll: function() {
                    return r.a.get()
                },
                remove: function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "default";
                    return r.a.remove("gindex-".concat("2.0.12", "-").concat(e))
                }
            },
            i = o,
            c = a("95a2"),
    ...
    cbd9: function(e, t, a) {
        ...
        function n(e) {
            var t = "https://cdn.jsdelivr.net/gh/rkafp/gindex-theme@v2.0.12/dist/";
            return t + e
        }
        a.d(t, "a", (function() {
            return n
                    ...
                    return new Promise(function() {
                        var e = Object(n["a"])(regeneratorRuntime.mark((function e(n) {
                            return regeneratorRuntime.wrap((function(e) {
                                while (1) switch (e.prev = e.next) {
                                    case 0:
                                        return a.mode = t || "list", e.next = 3, r("idnx/db/set", {
                                            dbName: "sys",
                                            path: "view.mode.value",
                                            value: a.mode,
                                            user: !0
    ...
    idn1: function(e) {
        e.exports = JSON.parse('{"_name":"Bahasa Indonesia","languages":"Bahasa","index":"Beranda","folder":"Folder","notify":{"title":"Pemberitahyan"},"copy":{"text":"Salin","success":"Berhasil menyalin","error":"Gagal menyalin"},"list":{"view":{"gridMode":"Mode Kisi","listMode":"Mode Daftar"},"auth":"Direktori dienkripsi, silahkan masukkan sandi","title":{"file":"Berkas","moditime":"Waktu Dimodifikasi","size":"Ukuran","operation":"Tindakan"},"loading":"Memuat...","opt":{"copy":"Salin tautan","newTab":"Buka tab baru","download":"Unduh"},"total":"Total","item":"barang"},"search":{"placeholder":"Cari sesuatu..."},"page":{"video":{"play":"Mulai","download":"Unduh","link":"Tautan unduh"},"text":{"loading":"Memuat..."}},"setting":{"clear":{"text":"Bersihkan cache","success":"Pembersihan cache berhasil"}},"checkVersion":{"tips":"Veri baru terdeteksi, <a href='${url}'>cek sekarang!</a>"},"error":{"shortcut_not_down":"Pintasan tidak dapat dibuka/diunduh","401":"Tidak sah, silahkan masuk"}}')
    },
    edd4: function(e) {
    ...
    f3f7: function(e, t, a) {
        ...
        var n = function() {
            ...
            c = {
                ...
                computed: Object(o["a"])({}, Object(i["mapState"])("idnx/view", ["mode"])),
                methods: Object(o["a"])({}, Object(i["mapActions"])("idnx/view", ["toggle"]), {
                    toggleMode: function() {
